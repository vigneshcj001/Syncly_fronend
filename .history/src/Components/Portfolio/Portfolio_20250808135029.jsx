    ...
    const fetchData = async () => {
      ...
      try {
        const [projRes, expRes, eduRes, certRes, portRes] = await Promise.all([
          api.get(`/api/projects/${user.slug}`),
          api.get(`/api/experiences/${user.slug}`),
          api.get(`/api/educations/${user.slug}`),
          api.get(`/api/certifications/${user.slug}`),
          api.get(`/api/portfolio/${user.slug}`),
        ]);
